...
function getStringPieceFromPieceRep(pieceRep) {
    if (pieceRep == CONSTANTS.T_PIECE_REPRESENTATION) {
        return CONSTANTS.GHOST_PIECE_REPRESENTATION + CONSTANTS.T_PIECE_REPRESENTATION + "  \n" +  CONSTANTS.T_PIECE_REPRESENTATION.repeat(3)
    }
    else if (pieceRep == CONSTANTS.O_PIECE_REPRESENTATION) {
        ...
        return (CONSTANTS.GHOST_PIECE_REPRESENTATION+  CONSTANTS.J_PIECE_REPRESENTATION + "\n").repeat(2) + CONSTANTS.J_PIECE_REPRESENTATION.repeat(2)
    }
    else if (pieceRep == CONSTANTS.L_PIECE_REPRESENTATION) {
        return (CONSTANTS.L_PIECE_REPRESENTATION + CONSTANTS.GHOST_PIECE_REPRESENTATION + "\n").repeat(2) + CONSTANTS.L_PIECE_REPRESENTATION.repeat(2)
    }
    else if (pieceRep == CONSTANTS.Z_PIECE_REPRESENTATION) {
        return  CONSTANTS.Z_PIECE_REPRESENTATION.repeat(2) + CONSTANTS.GHOST_PIECE_REPRESENTATION + "\n" +  CONSTANTS.GHOST_PIECE_REPRESENTATION + CONSTANTS.Z_PIECE_REPRESENTATION.repeat(2)
    }
    else if (pieceRep == CONSTANTS.S_PIECE_REPRESENTATION) {
        return CONSTANTS.GHOST_PIECE_REPRESENTATION + CONSTANTS.S_PIECE_REPRESENTATION.repeat(2) + "\n" +  CONSTANTS.S_PIECE_REPRESENTATION.repeat(2) + CONSTANTS.GHOST_PIECE_REPRESENTATION
    }
}
